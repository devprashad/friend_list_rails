...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference("Main.count") do
      post mains_url, params: { main: { email: @main.email, firstname: @main.firstname, lastname: @main.lastname, phone: @main.phone, twitter: @main.twitter } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { email: @main.email, firstname: @main.firstname, lastname: @main.lastname, phone: @main.phone, twitter: @main.twitter } }
